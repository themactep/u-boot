 ...
 */
static void t20_usb_phy_init(bool device)
{
...
{
	(void)dev;
	t20_usb_phy_init(true);		/* DEVICE_ONLY_MODE for DFU/g_dnl */
}
...
int board_init(void)
{
	...
	/*
	 * Only the host build (dr_mode="host", t20-isvp.dts) does the
	 * host PHY bring-up here. The DFU loader (t20-isvp-dfu.dts,

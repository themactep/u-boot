 ...
 * clk-t21 DM driver in U-Boot proper). The per-SKU APLL/MPLL setpoints
 ...
 * ddr_t21_types.c) and are selected at runtime by matching the &ddr
 * node's per-SKU compatible (ingenic,t21<sku>-ddr-innophy) - the same
 ...
 * model is up. T21 reuses the shared XBurst1 DDR driver (ddr_t31.c),

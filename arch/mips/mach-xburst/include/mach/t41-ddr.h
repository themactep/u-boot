...
/*
 * Ingenic T41 DDR controller and Innophy PHY register map.
 *
 * Per-variant DDR values (controller, PHY, mode register, geometry,
 * clocks) live in <mach/t41nq-ddr.h> or <mach/t41nq-ddr.h>; this file
...
#ifndef __T41_DDR_H__
#define __T41_DDR_H__

#include <mach/t41.h>		/* DDRC_BASE / DDR_PHY_BASE / CPM_BASE */
...
#define T41_INIT_COMP		(DDR_PHY_BASE + 0xd0)
...
#define T41_DDR_SIZE		DDR_CHIP_0_SIZE

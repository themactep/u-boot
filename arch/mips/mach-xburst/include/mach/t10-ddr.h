...
/*
 * Ingenic T10 DDR2 controller and Synopsys DWC PHY register map
 *
 * Profile: isvp_t10 (T10N) DDR2 M14D5121632A, 64 MB, 16-bit bus,
 * single CS0, 4-bank, DDR clock 400 MHz (MPLL 1200 / 3).
 *
 * T10, like T20, uses the Synopsys DesignWare (DWC) DDR PHY (the
 * JZ4775/JZ4780-generation controller, vendor arch/mips/cpu/xburst/
 * ddr_dwc.c + t10/ddr_set_dll.c), NOT the Innophy DDR2 core that
 * T21/T23/T30/T31 share. The DWC PHY has hardware impedance (ZQ)
 * calibration and a hardware DQS training engine. This is a mirror
 * of the HW-proven T20 DWC port with the T10-specific 400 MHz
 * parameter set.
 *
 * All register VALUEs and the impedance/ODT/RZQ/remap tables are the
 * exact vendor ddr_params_creator output for the isvp_t10_sfcnor
 * build (CONFIG_DDR2_M14D5121632A, CONFIG_SYS_MEM_FREQ = MPLL/3 =
 * 400 MHz, DDR2). The host-compiled creator was validated by
 ...
 * DDR_PHY_OFFSET = (-0x4e0000 + 0x1000) (vendor asm/arch-t10/
 * base.h), i.e. 0xb34f0000 - 0x4df000 = 0xb3011000.
 *
 * Copyright (c) 2019 Ingenic Semiconductor Co.,Ltd
 */

#ifndef __T10_DDR_H__
#define __T10_DDR_H__
...
/* CPM_DDRCDR (0x2c) comes from <mach/t10.h> */
 ...
 * isvp_t10_sfcnor (T10N, M14D5121632A, DDR2, 400 MHz). Tool
 * validated bit-for-bit against the T31 128 MB GOLD.
 *
 * Geometry (CFG/MMAP) matches the T20 64 MB set (same part); the
 * REFCNT / TIMING1-6 / MR0 / PTR0-1 / DTPR0-1 are the 400 MHz
 * computed values (T20 was 500 MHz, hence the deltas).
 */
...
#define DDRP_MR0_VALUE		0x00000a73
...
#define DDRP_PTR1_VALUE		0x05013880
#define DDRP_PTR2_VALUE		0x00000000
#define DDRP_DTPR0_VALUE	0x3092667a
#define DDRP_DTPR1_VALUE	0x002a0090
...
/* Clock targets: T10N MPLL 1200 MHz, DDR 400 MHz (MPLL/3, cdr = 2). */
#define DDR_MPLL_RATE		1200000000U
#define DDR_TARGET_RATE		400000000U

#define DDR_CHIP_0_SIZE		67108864	/* 64 MB */
#define DDR_CHIP_1_SIZE		0
#define T10_DRAM_SIZE		0x04000000u	/* 64 MB */

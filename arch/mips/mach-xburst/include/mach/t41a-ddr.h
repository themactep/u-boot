...
/*
 * Ingenic T41A DDR3 controller + Innophy PHY register values.
 *
 ...
 * `isvp_t41a_sfc_nor` defconfig (CONFIG_T41A +
 * CONFIG_DDR3_W631GU6NG + DDR_800M + APLL_1300M + DW32=0,
 * CS0-only).
 *
 * 128 MiB single W631GU6NG chip, 16-bit DDR3 @ 800 MHz,
 * APLL=1300, MPLL=1600, VPLL=1080.
 *
...
#ifndef __T41A_DDR_H__
#define __T41A_DDR_H__
...
/* Clock target: MPLL=1600 -> DDR=MPLL/2=800 MHz */
#define DDR_MPLL_RATE		1600000000U
#define DDR_TARGET_RATE		(DDR_MPLL_RATE / 2U)

/* T41A PLL MNOD - vendor T41-1.2.6 isvp_t41.h. Bit layout:
 *   PLLEN[0], LOCK[2], PLL_ON[3], PLLRG[6:4],
 *   PLLOD1[10:7], PLLOD0[13:11], PLLN[19:14], PLLM[28:20].
 */
#define T41_APLL_MNOD		((0x144 << 20) | (2 << 14) | (1 << 11) | (1 << 7) | (1 << 4))
#define T41_MPLL_MNOD		((0xc7  << 20) | (2 << 14) | (1 << 11) | (0 << 7) | (1 << 4))
#define T41_VPLL_MNOD		((0x59  << 20) | (0 << 14) | (1 << 11) | (1 << 7) | (3 << 4))

/* DDRC register values from ddr_params_creator (T41A + W631GU6NG + 800 MHz + 16-bit) */
...
#define DDRC_REFCNT_VALUE	0x6cc20083
#define DDRC_TIMING1_VALUE	0x08130c09
#define DDRC_TIMING2_VALUE	0x0a0a060d
#define DDRC_TIMING3_VALUE	0x030c040c
#define DDRC_TIMING4_VALUE	0x1c271c05
#define DDRC_TIMING5_VALUE	0x00050054
#define DDRC_AUTOSR_CNT_VALUE	0x2c001860
...
#define DDRP_CL_VALUE		0x0000000d
#define DDRP_CWL_VALUE		0x00000009
#define DDR_MR0_VALUE		0x00001d14

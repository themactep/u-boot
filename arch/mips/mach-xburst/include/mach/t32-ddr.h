 ...
 *
 * Profile: T32 (vendor PRJ007) DDR2 M14D5121632A, 64 MB, 16-bit bus,
 *   CS0 only. DDR controller 600 MHz (data rate; tCK 1666 ps).
 *
 * This is NOT the legacy XBurst1 DDRC used by T10-T31. T32 has a
 ...
 * PRJ007_l = M14D5121632A); the Innophy field map is taken verbatim
 * (last-wins resolved) from the vendor 2022.10 ddrc.h so the SPL
 * init in t32/sdram.c can be diff-audited against the vendor
